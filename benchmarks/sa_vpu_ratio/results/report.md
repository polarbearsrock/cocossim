...
**Corrected 2026-09-11.** These results supersede the first sweep. The timing oracle now resets its clock before native unit initialization. The previous order could add artificial stalls to short SA tiles: 32×32 output tiles with K=128 and K=1024 now take 161 and 1057 cycles, respectively, instead of the previously recorded 385 and 2049. Work counts and the scheduling policy are unchanged.
...
|---:|---:|---:|---:|---:|---:|
| 4:1 | 288 | 57.010 | -0.75% | 98.63% | 0.60% |
| 8:1 | 144 | 57.153 | -0.50% | 98.39% | 1.20% |
| 16:1 | 72 | 57.440 | +0.00% | 97.89% | 2.39% |
| 32:1 | 36 | 57.999 | +0.97% | 96.95% | 4.74% |
| 64:1 | 18 | 60.168 | +4.75% | 93.46% | 9.13% |
| 128:1 | 9 | 65.417 | +13.89% | 85.96% | 16.80% |
| 192:1 | 6 | 70.684 | +23.06% | 79.55% | 23.33% |
| 288:1 | 4 | 78.798 | +37.18% | 71.36% | 31.39% |
| 384:1 | 3 | 87.059 | +51.57% | 64.59% | 37.88% |
| 576:1 | 2 | 103.562 | +80.29% | 54.30% | 47.77% |
| 1152:1 | 1 | 153.089 | +166.52% | 36.73% | 64.63% |
...
|---:|---:|---:|---:|---:|
| 1 | 57.440 ms | 64:1 | 18 | 60.168 |
| 4 | 57.866 ms | 32:1 | 36 | 59.041 |
...
- Native SA, elementwise, and reduction tile timings checked against hand-calculated cycles; oracle clock isolation checked after longer preceding measurements.
