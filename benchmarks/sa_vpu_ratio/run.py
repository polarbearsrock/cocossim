...
def report(out, rows):
    ...
    lines = [
        ...
        '**Corrected 2026-09-11.** These results supersede the first sweep. The timing oracle now resets '
        'its clock before native unit initialization. The previous order could add artificial stalls to short SA tiles: '
        '32×32 output tiles with K=128 and K=1024 now take 161 and 1057 cycles, respectively, '
        'instead of the previously recorded 385 and 2049. Work counts and the scheduling policy are unchanged.', '',
...
def main():
    ...
    manifest={
        ...
        'timing_correction':'oracle clock reset precedes native initialization; supersedes first sweep',
